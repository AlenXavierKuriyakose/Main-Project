...
class RequirementPage2 extends StatefulWidget {
  @override
  _RequirementPageState createState() => _RequirementPageState();
}

class _RequirementPageState extends State<RequirementPage2> {
...
class _InterviewStatusPageState extends State<InterviewStatusPage> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.211:3000/api/interviews3'));
